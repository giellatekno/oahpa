...
import smnoahpa.settings as settings
...
from smnoahpa.settings import INFINITIVE_SUBTRACT as infinitives_sub
from smnoahpa.settings import INFINITIVE_ADD as infinitives_add
...
class LeksaSettings(OahpaSettings):
	semtype = forms.ChoiceField(initial='BODYPART', choices=SEMTYPE_CHOICES)
...
def vasta_is_correct(self,question,qwords,language,utterance_name=None):
    ...
    #logfile = open('/home/smn_oahpa/smn_oahpa/smn_drill/vastaF_log.txt','w')
...
def cealkka_is_correct(self,question,qwords,awords,language,question_id=None):  #was: question_id=None
    ...
    logfile = open('/home/smnoahpa/smnoahpa/smn_drill/vastas_log.txt', 'w')
    host = 'localhost'
    port = 9000  # was: 9000, TODO - add to settings.py
    size = 1024
