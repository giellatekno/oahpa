...
from models import *
#from game import * 
#from davvi_oahpa.davvi_drill.game import relax
import datetime
import socket
import sys, os, re
import itertools
...
def vasta_is_correct(self,question,qwords,language,utterance_name=None):
	...
	#logfile = open('/home/davvi_oahpa/davvi_oahpa/davvi_drill/vastaF_and_Sahka_CGanalysis_log.txt','w')
...
def cealkka_is_correct(self,question,qwords,awords,language,question_id=None):  #was: question_id=None
	...
	#logfile = open('/home/davvi_oahpa/davvi_oahpa/davvi_drill/CGanalysis_log.txt', 'w')
	host = 'localhost'
	port = settings.LOOKUPSERV_PORT
	size = 1024
