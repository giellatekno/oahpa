...
from davvi_drill.models import Tagname, Tagset, Form, filter_set_by_dialect
...
class Command(BaseCommand):
    ...
    def test_agreement(self):
        fname = 'davvi_drill/management/commands/testquestions_agreement_defs.yaml'
    ...
    def handle(self, *args, **options):
        ...
        agreement_defs = 'davvi_drill/management/commands/testquestions_agreement_defs.yaml'
