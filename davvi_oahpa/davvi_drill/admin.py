from davvi_drill.models import Log, Word, Semtype, Source, Form, Tag, Feedbackmsg, Feedbacktext, Question, QElement, WordQElement, WordTranslation
from django.contrib import admin
######from django.contrib.contenttypes import generic # not needed in django 1.8 # not needed in django 1.8 # not needed in django 1.8 # not needed in django 1.8 # not needed in django 1.8 # not needed in django 1.8
