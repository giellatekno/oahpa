# from davvi_oahpa.courses.models import CourseMembership
...
@disable_for_loaddata
def user_postsave(sender, instance, **kwargs):
    ...
    userprofile = None
    try:
        userprofiles = instance.userprofile_set.all() #get_profile()
        if userprofiles:
