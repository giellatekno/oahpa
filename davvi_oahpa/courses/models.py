...
class UserProfile(models.Model):
    ...
    def open_id_link(self):
        return 'http://oahpa.uit.no/davvi_oahpa/openid/%s' % self.user.username
...
post_save.connect(create_profile, sender=User,
    dispatch_uid="davvi_oahpa.courses.models.post_save")
...
post_delete.connect(course_relationship_postdelete, sender=CourseRelationship,
    dispatch_uid="davvi_oahpa.courses.models.pre_save")

post_save.connect(user_postsave, sender=User,
    dispatch_uid="davvi_oahpa.courses.models.pre_save") # changed form pre to post
