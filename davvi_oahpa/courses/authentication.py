...
class CookieAuthMiddleware(object):
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        # For admin pages...
        if view_func.__module__.startswith('django.contrib.auth.'): # view_func.__module__.startswith('django.contrib.admin.')
