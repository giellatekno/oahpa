...
def relax(strict):
    ...
    E.g., *ry¬Å¯jnesj¬Å‰jja is accepted for ry¬Åˆjnesj¬ÅÊjja
    (user types ¬Å¯ instead of ¬Åˆ consistently)

    ... but ...

      *t¬ÅˆÅ¯lledh is not accepted for t¬ÅˆÅˆlledh
      (user mixes the two in one word)

      Similarly, directionality is included. <i> is accepted for <¬ÅÔ>, but
      not vice versa.

      E.g.:  *¬ÅÂÅÂjmed¬ÅÔdh is not accepted for ¬ÅÂÅÂjmedidh,
      ... but ...
      *miele is accepted for m¬ÅÔele.
