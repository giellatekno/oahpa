# Django settings for liv_oahpa project.
# -*- encoding: utf-8 -*-
import os.path
import sys

os.environ['PYTHON_EGG_CACHE'] = '/tmp'
os.environ['DJANGO_SETTINGS_MODULE'] = 'vro_oahpa.settings'
...
path = '/Users/mslm/main/ped/vro_oahpa'
...
# DATABASE_NAME = here('vrooahpa.db.sql')             # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = (
	...
	os.path.join(os.path.dirname(__file__), 'vro_drill/templates').replace('\\','/'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = ( "django.contrib.auth.context_processors.auth",
				...
				"vro_oahpa.courses.context_processors.request_user",
				"vro_oahpa.conf.context_processors.dialect",
				"vro_oahpa.conf.context_processors.site_root",
				"vro_oahpa.conf.context_processors.grammarlinks",
)
...
if os.uname()[1] == 'gtlab.uit.no':
    FST_DIRECTORY = '/opt/smi/vro/bin'
    LOOKUP_TOOL = '/usr/local/bin/lookup'
else:
    FST_DIRECTORY = '/Users/mslm/main/langs/vro/src'
...
LOGIN_REDIRECT_URL = '/vro_oahpa/courses/'
LOGIN_URL = '/vro_oahpa/courses/login/'

CACHES = {
	'default': {
		'BACKEND': 'django.core.cache.backends.filebased.FileBasedCache',
		'LOCATION': '/var/tmp/vrooahpa_cache'
	},
}
