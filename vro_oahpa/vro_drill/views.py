...
class Morfaview(Gameview):
	gamenames = {
        ...
        'A-ELA': _('Practise elative'),
        'A-ALL':  _('Practise allative'),
        'A-ADE': _('Practise adessive'),
        'A-ABL':  _('Practise ablative'),
        'A-TRA': _('Practise translative'),
		'N-ILL-ALL':  _('Choose between illative and allative'),
		'N-INE-ADE':  _('Choose between inessive and adessive'),
		'N-GEN-NOM':  _('Practice object. Choose between genitive and nominative'),
