...
urlpatterns = patterns('',
	...
	url(r'^%s/courses/' % prefix, include('vro_oahpa.courses.urls')),
	url(r'^%s/' % prefix, include('vro_oahpa.vro_drill.urls')),
	url(r'^%s/dialect/$' % prefix, 'vro_oahpa.conf.views.dialect'),
	url(admin_url, include(admin.site.urls)),
	# (r'^admin/doc/', include('django.contrib.admindocs.urls')),
	#url(r'^%s/openid/' % prefix, include('vro_oahpa.openid_provider.urls')),
)
