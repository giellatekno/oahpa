...
Figure \ref{maidlohket} shows how the vislcg3 file has disambiguated and added the tag about a missing accusative to the analysis from Figure \ref{iktelohken}. The grammatical error tag is used for generating feedback for the student. 
