...
%The central goals for the development of the pedagogical programs were that the programs
...
Because of the complex morphology in Sámi languages, it demands a lot of practising before the student reaches necessary skills. But Sámi is a minority language and it is a common situation that the person learning Sámi does not get enough opportunities to practise the language in a natural setting. Because of that, programs accessible on the Internet may be a useful supplement to the instruction given at school or in university. We also wanted to make a dialogue program about everyday topics, with underlying pedagogical goal to exercise verb inflection, choosing the correct case and learn more words. 
...
\begin{figure}[tbp]
\begin{center}
\scalebox{.48}[.48]{\includegraphics{presentation/img/nounlexicon3.png}}\\
...
We have chosen not to use multiple-choice, but rather let the student formulate his/her own answer. To a certain question one may give many kinds of acceptable answers. In Sámi one may change word order, and also add many kinds of particles. 
...
\newblock Copenhaguen: Museum Tusculanum.
...
\newblock Copenhagen Studies in Language.
