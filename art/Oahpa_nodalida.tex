...
In section 2 we describe the initial linguistic resources and the pedagogical motivation behind the programs. Section 3 presents the basic design of different parts of the programs. The fourth section concentrates on how the CG-parser was utilised in the programs that allow free formation of sentences (sh: better wording here). Section 5 contains an evaluation of the programs.
