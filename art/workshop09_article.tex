...
The CG rules used in the dialogue processing may be divided into two types: general rules that may target any question-answer pair and question-specific rules that are tailored for a specific question. %Whereas the general rules often detect grammatical errors and e.g. determine if user's answer was affirmative or negative, the question specific rules may be used for more sophisticated error detection and navigation in the dialogue.
