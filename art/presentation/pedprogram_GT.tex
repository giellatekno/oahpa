...
\item stringmatch, f.eks. \textit{gusas} = 5 bokstaver 
\end{itemize} %\pause
%\begin{block}{ }
%Spåkteknologi:
%\begin{itemize}
...
\frame{\frametitle{Med alle analyser blir det homonymi}

\scalebox{.6}[.6]{\includegraphics{img/norsk_multi.png}}
}

\frame{\frametitle{Ved hjelp av regler velges riktig analyse}
...
\begin{block}{ }
\textit{http://visl.sdu.dk} og \textit{http://beta.visl.sdu.dk} 
\end{block}{ }


Med programmer for mange språk -- drilling av ordklasser og syntaks, men også litt ordbøyning og quiz.\\
\begin{block}{ }
\scriptsize{arabisk,
bosnisk,
dansk,
...
Vi har lagt til 1450 analyserte nordsamiske setninger.
\end{block}{ }
...
\frame{\frametitle{OAHPA -- for dem som lærer seg samisk}
...
\begin{block}{ }
Programmene lages ved UiT og ligger på server på internett. \\ De kan lages for andre språk også - hvis man har tilgang på analysator.
\end{block}{ }
...
\frame{\frametitle{Morfa -- trene på å bøye ord} 
...
Uttalige akseptable svar -- f.eks.
\begin{itemize}
