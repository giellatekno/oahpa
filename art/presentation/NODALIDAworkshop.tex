...
\section{2. Basic grammatical analysis} 
...
\section{3. Analysing the user's input}
...
\section{3a. Navigation and picking information}
...
\frame{\frametitle{Picking information} 
}
...
\begin{itemize}
\item Answering I-don't-know is too simple. Try again.
...
\frame{\frametitle{What grammar errors we have rules for} 
\begin{itemize}
\item verbs: finite, infinite, correct tense, negative form
\item case of argument based of the interrogative in the question
\item case of argument on based of valency
\item locative vs. illative based on movement
\item subject/verbal agreement
\item case and number in numeral expressions 
\item case after postposition 
\item postposition based of the interrogative in the question  
\item eret  
\item agreement inside NP 
\item timeexpressions 
\item particles and word order 
