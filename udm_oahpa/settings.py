# Django settings for udm_oahpa project.
# -*- encoding: utf-8 -*-
import os.path
import sys

os.environ['PYTHON_EGG_CACHE'] = '/tmp'
os.environ['DJANGO_SETTINGS_MODULE'] = 'udm_oahpa.settings'
...
path = '/Users/mslm/main/ped/udm_oahpa'
...
# DATABASE_NAME = here('udmoahpa.db.sql')             # Or path to database file if using sqlite3.
...
# http://testing.oahpa.no/udm_oahpa/

# URL_PREFIX = 'smaoahpa'
URL_PREFIX = 'udm_oahpa'
# URL_PREFIX = '책arjel'

# Absolute path to the directory that holds media.
#MEDIA_ROOT = "/home/udm_oahpa/udm_oahpa/media/"
...
TEMPLATE_DIRS = (
	...
	os.path.join(os.path.dirname(__file__), 'udm_drill/templates').replace('\\','/'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = ( "django.contrib.auth.context_processors.auth",
				...
				"udm_oahpa.courses.context_processors.request_user",
				"udm_oahpa.conf.context_processors.dialect",
				"udm_oahpa.conf.context_processors.site_root",
				"udm_oahpa.conf.context_processors.grammarlinks",
)
...
INSTALLED_APPS = (
	...
	'udm_oahpa.udm_drill',
        'udm_oahpa.conf',
	# 'udm_oahpa.courses',
        #'udm_oahpa.udm_feedback',
        'udm_oahpa.management',
        'gunicorn',
)
...
if os.uname()[1] == 'gtlab.uit.no':
    FST_DIRECTORY = '/opt/smi/udm/bin'
    LOOKUP_TOOL = '/usr/local/bin/lookup'
else:
    FST_DIRECTORY = '/Users/mslm/main/langs/udm/src'
...
LOGIN_REDIRECT_URL = '/udm_oahpa/courses/'
LOGIN_URL = '/udm_oahpa/courses/login/'

CACHES = {
	'default': {
		'BACKEND': 'django.core.cache.backends.filebased.FileBasedCache',
		'LOCATION': '/var/tmp/udmoahpa_cache'
	},
}
