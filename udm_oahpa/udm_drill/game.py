...
from udm_oahpa.udm_drill.models import *
from udm_oahpa.udm_drill.forms import *
...
try:
	L1 = udm_oahpa.settings.L1
except:
	L1 = 'udm'  # was: sme

try:
	LOOKUP_TOOL = udm_oahpa.settings.LOOKUP_TOOL
except:
	LOOKUP_TOOL = 'lookup'


try:
	FST_DIRECTORY = udm_oahpa.settings.FST_DIRECTORY
except:
	FST_DIRECTORY = False

try:
	DEFAULT_DIALECT = udm_oahpa.settings.DEFAULT_DIALECT
except:
