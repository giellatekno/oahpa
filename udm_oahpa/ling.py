...
class Paradigm:
	...
	def generate_all(self, dialects):		
		...
		dialect = 'main'  # HU: There are no dialects defined for udm. I have defined this just to make the program work.
