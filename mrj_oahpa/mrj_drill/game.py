...
from mrj_oahpa.mrj_drill.models import *
from mrj_oahpa.mrj_drill.forms import *
...
try:
	L1 = mrj_oahpa.settings.L1
except:
	L1 = 'mrj'  # was: sme

try:
	LOOKUP_TOOL = mrj_oahpa.settings.LOOKUP_TOOL
except:
	LOOKUP_TOOL = 'lookup'


try:
	FST_DIRECTORY = mrj_oahpa.settings.FST_DIRECTORY
except:
	FST_DIRECTORY = False

try:
	DEFAULT_DIALECT = mrj_oahpa.settings.DEFAULT_DIALECT
except:
