...
from sms_drill.game import BareGame

class BareFSTGame(BareGame):
	...
	def create_form(self, db_info, n, data=None):
		...
		# TODO: basically redo this but with the FST

		# morph = (MorfaQuestion(
		# 			TODO: correct=correct,
		# 			TODO: accepted_answers=accepted_answers,
		# 			TODO: answer_presentation=presentation_ng,
		# 			TODO: translations=translations,
		# 			TODO: data=data,
		# 			TODO: prefix=n,
		# 			TODO: conneg=db_info['conneg'])
		# 		)
		...
		# TODO: this comes from the FST lookups
		form_list = []
