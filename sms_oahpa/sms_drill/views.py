...
def leksa_game(request, place=False):
	...
	if sess_lang:
		...
		if sess_lang == 'sms':  # was: sme
			sess_lang = 'rus'  # was: nob
	else:
		sess_lang = 'nob'

	default_langpair = 'sms%s' % sess_lang  # was: sme
...
class Morfaview(Gameview):
	gamenames = {
		...
		'A-NOMPL':  _('Practise adjectives in plural'),
		'N-LOC':  _('Practise adjectives in locative'),
		'A-COMP':  _('Practise comparative'),
		'A-SUPERL':  _('Practise superlative'),
		'A-PAR': _('Practise adjectives in partitive'),
	    'A-ABESS': _('Practise adjectives in abessive'),
		'A-GEN-PL': _('Practise adjectives in genitive plural'),
	    'A-ACC-PL': _('Practise adjectives in accusative plural'),
	    'A-ILL-PL': _('Practise adjectives in illative plural'),
	    'A-LOC-PL': _('Practise adjectives in locative plural'),
	    'A-COM-PL': _('Practise adjectives in comitative plural'),
	    'A-ABESS-PL': _('Practise adjectives in abessive plural'),
		...
		'PxSg1': _('Practise possessive suffixes'),
        'PxSg2': _('Practise possessive suffixes'),
        'PxSg3': _('Practise possessive suffixes'),
        'PxPl1': _('Practise possessive suffixes'),
        'PxPl2': _('Practise possessive suffixes'),
        'PxPl3': _('Practise possessive suffixes'),
		...
		'NOMPL':  _('Practise nominative in plural'),
		...
		'N-NOM-PL':  _('Practise nominative in plural'),
		'N-GEN-PL': _('Practise genitive in plural'),
	    'N-ACC-PL': _('Practise accusative in plural'),
	    'N-ILL-PL': _('Practise illative in plural'),
	    'N-LOC-PL': _('Practise locative in plural'),
	    'N-SG-COM': _('Practise comitative in singular'),
	    'N-PL-COM': _('Practise comitative in plural'),
