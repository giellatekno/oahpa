...
def index(request):
	...
	return render_to_response('mhr_oahpa_main.html', c,
...
def leksa_game(request, place=False):
	...
	if sess_lang:
		...
		if sess_lang in ['mhr', 'eng']: # maybe need to remove 'eng' from this list later on 
			sess_lang = 'est' # was: nob
	else:
		sess_lang = 'est' # was: nob

	default_langpair = 'mhr%s' % sess_lang
