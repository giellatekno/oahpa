...
from mhr_oahpa.mhr_drill.models import *
from mhr_oahpa.mhr_drill.forms import *
...
try:
	L1 = mhr_oahpa.settings.L1
except:
	L1 = 'mhr'  # was: sme

try:
	LOOKUP_TOOL = mhr_oahpa.settings.LOOKUP_TOOL
except:
	LOOKUP_TOOL = 'lookup'


try:
	FST_DIRECTORY = mhr_oahpa.settings.FST_DIRECTORY
except:
	FST_DIRECTORY = False

try:
	DEFAULT_DIALECT = mhr_oahpa.settings.DEFAULT_DIALECT
except:
