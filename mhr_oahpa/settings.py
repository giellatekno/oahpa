# Django settings for mhr_oahpa project.
# -*- encoding: utf-8 -*-
import os.path
import sys

os.environ['PYTHON_EGG_CACHE'] = '/tmp'
os.environ['DJANGO_SETTINGS_MODULE'] = 'mhr_oahpa.settings'
...
path = '/Users/mslm/main/ped/mhr_oahpa'
...
# DATABASE_NAME = here('mhroahpa.db.sql')             # Or path to database file if using sqlite3.
...
# URL_PREFIX = 'smaoahpa'
URL_PREFIX = 'mhr_oahpa'
# URL_PREFIX = '책arjel'

# Absolute path to the directory that holds media.
#MEDIA_ROOT = "/home/mhr_oahpa/mhr_oahpa/media/"
...
TEMPLATE_DIRS = (
	...
	os.path.join(os.path.dirname(__file__), 'mhr_drill/templates').replace('\\','/'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = ( "django.contrib.auth.context_processors.auth",
				...
				"mhr_oahpa.courses.context_processors.request_user",
				"mhr_oahpa.conf.context_processors.dialect",
				"mhr_oahpa.conf.context_processors.site_root",
				"mhr_oahpa.conf.context_processors.grammarlinks",
)
...
INSTALLED_APPS = (
	...
	'mhr_oahpa.mhr_drill',
        'mhr_oahpa.conf',
	# 'mhr_oahpa.courses',
        #'mhr_oahpa.mhr_feedback',
        'mhr_oahpa.management',
        'gunicorn',
)
...
MAIN_LANGUAGE = ('mhr', 'Eastern Mari')
L1 = MAIN_LANGUAGE[0]
...
if os.uname()[1] == 'gtlab.uit.no':
    FST_DIRECTORY = '/opt/smi/mhr/bin'
    LOOKUP_TOOL = '/usr/local/bin/lookup'
else:
    FST_DIRECTORY = '/Users/mslm/main/langs/mhr/src'
...
LOGIN_REDIRECT_URL = '/mhr_oahpa/courses/'
LOGIN_URL = '/mhr_oahpa/courses/login/'

CACHES = {
	'default': {
		'BACKEND': 'django.core.cache.backends.filebased.FileBasedCache',
		'LOCATION': '/var/tmp/mhroahpa_cache'
	},
}
