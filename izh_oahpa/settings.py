# Django settings for izh_oahpa project.
# -*- encoding: utf-8 -*-
import os.path
import sys
...
path = '/Users/mslm/main/ped/izh_oahpa'
...
# DATABASE_NAME = here('izhoahpa.db.sql')             # Or path to database file if using sqlite3.
...
# URL_PREFIX = 'smaoahpa'
URL_PREFIX = 'izh_oahpa'
# URL_PREFIX = '책arjel'

# Absolute path to the directory that holds media.
#MEDIA_ROOT = "/home/izh_oahpa/izh_oahpa/media/"
...
TEMPLATE_DIRS = (
	...
	os.path.join(os.path.dirname(__file__), 'izh_drill/templates').replace('\\','/'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = ( "django.contrib.auth.context_processors.auth",
				...
				"izh_oahpa.courses.context_processors.request_user",
				"izh_oahpa.conf.context_processors.dialect",
				"izh_oahpa.conf.context_processors.site_root",
				"izh_oahpa.conf.context_processors.grammarlinks",
)
...
INSTALLED_APPS = (
	...
	'izh_oahpa.izh_drill',
        'izh_oahpa.conf',
	# 'izh_oahpa.courses',
        #'izh_oahpa.izh_feedback',
        'izh_oahpa.management',
        'gunicorn',
)
...
if os.uname()[1] == 'gtlab.uit.no':
    FST_DIRECTORY = '/opt/smi/izh/bin'
    LOOKUP_TOOL = '/usr/local/bin/lookup'
else:
    FST_DIRECTORY = '/Users/mslm/main/langs/izh/src'
...
LOGIN_REDIRECT_URL = '/izh_oahpa/courses/'
LOGIN_URL = '/izh_oahpa/courses/login/'

CACHES = {
	'default': {
		'BACKEND': 'django.core.cache.backends.filebased.FileBasedCache',
		'LOCATION': '/var/tmp/izhoahpa_cache'
	},
}
