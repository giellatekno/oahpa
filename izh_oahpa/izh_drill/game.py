...
from izh_oahpa.izh_drill.models import *
from izh_oahpa.izh_drill.forms import *
...
try:
	L1 = izh_oahpa.settings.L1
except:
	L1 = 'izh'  # was: sme

try:
	LOOKUP_TOOL = izh_oahpa.settings.LOOKUP_TOOL
except:
	LOOKUP_TOOL = 'lookup'


try:
	FST_DIRECTORY = izh_oahpa.settings.FST_DIRECTORY
except:
	FST_DIRECTORY = False

try:
	DEFAULT_DIALECT = izh_oahpa.settings.DEFAULT_DIALECT
except:
