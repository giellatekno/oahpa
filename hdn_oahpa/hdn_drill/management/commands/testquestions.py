...
from hdn_drill.models import Tagname, Tagset, Form
...
class Command(BaseCommand):
    ...
    def test_agreement(self):
        fname = 'hdn_drill/management/commands/testquestions_agreement_defs.yaml'
    ...
    def handle(self, *args, **options):
        ...
        agreement_defs = 'hdn_drill/management/commands/testquestions_agreement_defs.yaml'
