...
# Inflection to and from the lemma (20)

	'V-Lemma_2_Simple_Present': [('V', 'V+Simp+Pres')],
	'V-Simple_Present_2_Lemma': [('V+Simp+Pres', 'V')],
	'V-Lemma_2_Negative_Simple_Present': [('V', 'V+Neg+Simp+Pres')],
	'V-Negative_Simple_Present_2_Lemma': [('V+Neg+Simp+Pres', 'V')],

	'V-Lemma_2_Direct_Past': [('V', 'V+Dir+Past')],
	'V-Direct_Past_2_Lemma': [('V+Dir+Past', 'V')],
	'V-Lemma_2_Negative_Direct_Past': [('V', 'V+Neg+Dir+Past')],
	'V-Direct_Past_2_Lemma': [('V+Neg+Dir+Past', 'V')],

	'V-Lemma_2_Simple_Future': [('V', 'V+Simp+Fut')],
	'V-Simple_Future_2_Lemma': [('V+Simp+Fut', 'V')],
	'V-Lemma_2_Negative_Simple_Future': [('V', 'V+Neg+Simp+Fut')],
	'V-Negative_Simple_Future_2_Lemma': [('V+Neg+Simp+Fut', 'V')],

	'V-Lemma_2_Present_Habitual': [('V', 'V+Pres+Hab')],
	'V-Present_Habitual_2_Lemma': [('V+Pres+Hab', 'V')],
	'V-Lemma_2_Negative_Present_Habitual': [('V', 'V+Neg+Pres+Hab')],
	'V-Negative_Present_Habitual_2_Lemma': [('V+Neg+Pres+Hab', 'V')],

	'V-Lemma_2_Past_Habitual': [('V', 'V+Past+Hab')],
	'V-Past_Habitual_2_Lemma': [('V+Past+Hab', 'V')],
	'V-Lemma_2_Negative_Past_Habitual': [('V', 'V+Neg+Past+Hab')],
	'V-Negative_Past_Habitual_2_Lemma': [('V+Neg+Past+Hab', 'V')],


# Change of polarity, with tense staying the same (10)

	'V-Simple_Present_2_Negative_Simple_Present': [('V+Simp+Pres', 'V+Neg+Simp+Pres')],
	'V-Negative_Simple_Present_2_Simple_Present': [('V+Neg+Simp+Pres', 'V+Simp+Pres')],

	'V-Direct_Past_2_Negative_Direct_Past': [('V+Dir+Past', 'V+Neg+Dir+Past')],
	'V-Negative_Direct_Past_2_Direct_Past': [('V+Neg+Dir+Past', 'V+Dir+Past')],

	'V-Simple_Future_2_Negative_Simple_Future': [('V+Simp+Fut', 'V+Neg+Simp+Fut')],
	'V-Negative_Simple_Future_2_Simple_Future': [('V+Neg+Simp+Fut', 'V+Simp+Fut')],

	'V-Present_Habitual_2_Negative_Present_Habitual': [('V+Pres+Hab', 'V+Neg+Pres+Hab')],
	'V-Negative_Present_Habitual_2_Present_Habitual': [('V+Neg+Pres+Hab', 'V+Pres+Hab')],

	'V-Past_Habitual_2_Negative_Past_Habitual': [('V+Past+Hab', 'V+Neg+Past+Hab')],
	'V-Negative_Past_Habitual_2_Past_Habitual': [('V+Neg+Past+Hab', 'V+Past+Hab')],


# Change of tense, with polarity and aspect staying the same (16)

	'V-Simple_Present_2_Direct_Past': [('V+Simp+Pres', 'V+Dir+Past')],
	'V-Direct_Past_2_Simple_Present': [('V+Dir+Past', 'V+Simp+Pres')],
	'V-Simple_Future_2_Direct_Past': [('V+Simp+Fut', 'V+Dir+Past')],
	'V-Direct_Past_2_Simple_Future': [('V+Dir+Past', 'V+Simp+Fut')],
	'V-Simple_Present_2_Simple_Future': [('V+Simp+Pres', 'V+Simp+Fut')],
	'V-Simple_Future_2_Simple_Present': [('V+Simp+Fut', 'V+Simp+Pres')],
	'V-Present_Habitual_2_Past_Habitual': [('V+Pres+Hab', 'V+Past+Hab')],
	'V-Past_Habitual_2_Present_Habitual': [('V+Past+Hab', 'V+Pres+Hab')],

	'V-Negative_Simple_Present_2_Negative_Direct_Past': [('V+Neg+Simp+Pres', 'V+Neg+Dir+Past')],
	'V-Negative_Direct_Past_2_Negative_Simple_Present': [('V+Neg+Dir+Past', 'V+Neg+Simp+Pres')],
	'V-Negative_Simple_Future_2_Negative_Direct_Past': [('V+Neg+Simp+Fut', 'V+Neg+Dir+Past')],
	'V-Negative_Direct_Past_2_Negative_Simple_Future': [('V+Neg+Dir+Past', 'V+Neg+Simp+Fut')],
	'V-Negative_Simple_Present_2_Negative_Simple_Future': [('V+Neg+Simp+Pres', 'V+Neg+Simp+Fut')],
	'V-Negative_Simple_Future_2_Negative_Simple_Present': [('V+Neg+Simp+Fut', 'V+Neg+Simp+Pres')],
	'V-Negative_Present_Habitual_2_Negative_Past_Habitual': [('V+Neg+Pres+Hab', 'V+Neg+Past+Hab')],
	'V-Negative_Past_Habitual_2_Negative_Present_Habitual': [('V+Neg+Past+Hab', 'V+Neg+Pres+Hab')],

#  Change of aspect, with tense and polarity staying the same (8)

	'V-Simple_Present_2_Present_Habitual': [('V+Simp+Pres', 'V+Pres+Hab')],
	'V-Present_Habitual_2_Simple_Present': [('V+Pres+Hab', 'V+Simp+Pres')],
	'V-Direct_Past_2_Past_Habitual': [('V+Dir+Past', 'V+Past+Hab')],
	'V-Past_Habitual_2_Direct_Past': [('V+Past+Hab', 'V+Dir+Past')],

	'V-Negative_Simple_Present_2_Negative_Present_Habitual': [('V+Neg+Simp+Pres', 'V+Neg+Pres+Hab')],
	'V-Negative_Present_Habitual_2_Negative_Simple_Present': [('V+Neg+Pres+Hab', 'V+Neg+Simp+Pres')],
	'V-Negative_Direct_Past_2_Negative_Past_Habitual': [('V+Neg+Dir+Past', 'V+Neg+Past+Hab')],
	'V-Negative_Past_Habitual_2_Negative_Direct_Past': [('V+Neg+Past+Hab', 'V+Neg+Dir+Past')],

#  Change of interrogativity, keeping tense and polarity and aspect the same (10)

	'V-Simple_Present_2_Interrogative_Simple_Present': [('V+Simp+Pres', 'V+Interr+Simp+Pres')],
	'V-Interrogative_Simple_Present_2_Simple_Present': [('V+Interr+Simp+Pres', 'V+Simp+Pres')],

	'V-Direct_Past_2_Interrogative_Past': [('V+Dir+Past', 'V+Interr+Past')],
	'V-Interrogative_Simple_Present_2_Simple_Present': [('V+Interr+Past', 'V+Dir+Past')],

	'V-Simple_Future_2_Interrogative_Simple_Future': [('V+Simp+Fut', 'V+Interr+Fut+Long')],
	'V-Interrogative_Simple_Present_2_Simple_Present': [('V+Interr+Fut+Long', 'V+Fut+Long')],

	'V-Present_Habitual_2_Interrogative_Present_Habitual': [('V+Pres+Hab', 'V+Interr+Pres+Hab')],
	'V-Interrogative_Present_Habitual_2_Present_Habitual': [('V+Interr+Pres+Hab', 'V+Pres+Hab')],

	'V-Past_Habitual_2_Interrogative_Past_Habitual': [('V+Past+Hab', 'V+Interr+Past+Hab')],
	'V-Interrogative_Past_Habitual_2_Past_Habitual': [('V+Interr+Past+Hab', 'V+Past+Hab')],
