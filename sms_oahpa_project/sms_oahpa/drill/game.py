		...
		if pos == 'A':
			if pos2 == 'Num':
				 ...
				 TAG_QUERY = TAG_QUERY & \
						...
						Q(case=case) & \
						Q(number__in=number)
			print "Tag query5: ", TAG_QUERY

		if pos == 'Px':
			TAG_QUERY = TAG_QUERY & Q(case=case)
			print "Tag query6: ", TAG_QUERY
...
class QuizzGame(Game):
	...
	def get_db_info(self, db_info):
		...
		#target_language = self.settings['transtype'][-2::]
