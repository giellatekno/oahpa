...
CASE_CONTEXT_CHOICES = (
	#('N-NOM-PL', _('plural')),
	('N-SG-ACC', _('singular accusative')),
	('N-PL-ACC', _('plural accusative')),
	#('N-GEN', _('genitive')),
	#('N-ILL', _('illative')),
	#('N-LOC', _('locative')),
...
DERIVATION_CHOICES = (
 	('V-DER-N-Ag', _('verb->agent derivation')),
 	('V-DER-N-Act', _('verb->action derivation')),
...
class OahpaQuestion(forms.Form):
	...
	answer = forms.CharField(widget=forms.TextInput(attrs=answer_attrs))
