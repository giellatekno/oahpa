...
class Word(models.Model):
	...
	hid = models.IntegerField(null=True, default=None) # The number of the homonym (1, 2, etc.)
...
class Form(models.Model):
	...
	dialects = models.ManyToManyField(Dialect, blank=True)
	feedback = models.ManyToManyField('Feedbackmsg', blank=True)
 	objects = BulkManager()
