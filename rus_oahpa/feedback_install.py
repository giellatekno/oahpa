...
Trond: The following is documentation for sma, it should be cut down,
and kept to a language-independent minumum.
...
from rus_drill.models import Feedbackmsg,Feedbacktext,Dialect,Comment,Tag
...
from rus_drill.models import Form
