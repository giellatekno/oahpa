...
from rusoahpa.rus_drill.models import *
from rusoahpa.rus_drill.forms import *

from rusoahpa.conf.tools import switch_language_code
...
try:
	L1 = rusoahpa.settings.L1
except:
	L1 = 'rus'  # was: sme

try:
	LOOKUP_TOOL = rusoahpa.settings.LOOKUP_TOOL
except:
	LOOKUP_TOOL = 'lookup'


try:
	FST_DIRECTORY = rusoahpa.settings.FST_DIRECTORY
except:
	FST_DIRECTORY = False

try:
	DEFAULT_DIALECT = rusoahpa.settings.DEFAULT_DIALECT
except:
...
class NumGame(Game):
	generate_fst = 'rus-num.fst'
	answers_fst = 'rus-inum.fst'
...
class Klokka(NumGame):
	...
	generate_fst = 'iclock-rus.fst'
	answers_fst = 'clock-rus.fst'
...
class Dato(Klokka):
	...
	generate_fst = 'idate-rus.fst'
	answers_fst = 'date-rus.fst'
