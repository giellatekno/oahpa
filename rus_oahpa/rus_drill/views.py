...
class Morfaview(Gameview):
	gamenames = {
		...
		'N-GEN2':  _('Practice genitive 2'),
		'N-ACC-SG':  _('Practice accusative singular'),
		'N-ACC-PL':  _('Practice accusative plural'),
		'N-DAT-SG':  _('Practice dative singular'),
		'N-DAT-PL':  _('Practice dative plural'),
		'N-INS-SG':  _('Practice instrumental singular'),
		'N-INS-PL':  _('Practice instrumental plural'),
		'N-GEN-SG':  _('Practice genitive singular'),
		'N-GEN-PL':  _('Practice genitive plural'),
		'N-LOC-SG':  _('Practice locative singular'),
        'N-LOC2':  _('Practice locative 2'),
		'N-LOC-PL':  _('Practice locative plural'),
