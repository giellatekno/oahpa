...
class Morfaview(Gameview):
	gamenames = {
		...
		'N-NOM-PL':  _('Practise nominative plural'),
		'N-GEN2':  _('Practise genitive 2'),
		'N-ACC-SG':  _('Practise accusative singular'),
		'N-ACC-PL':  _('Practise accusative plural'),
		'N-DAT-SG':  _('Practise dative singular'),
		'N-DAT-PL':  _('Practise dative plural'),
		'N-INS-SG':  _('Practise instrumental singular'),
		'N-INS-PL':  _('Practise instrumental plural'),
		'N-GEN-SG':  _('Practise genitive singular'),
		'N-GEN-PL':  _('Practise genitive plural'),
		'N-LOC-SG':  _('Practise locative singular'),
		'N-LOC-PL':  _('Practise locative plural'),
