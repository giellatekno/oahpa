...
def leksa_game(request, place=False):
	...
	default_langpair = 'fkv%s' % sess_lang
...
class Morfaview(Gameview):
	gamenames = {
		...
		'A-ELA': _('Practise adjectives in elative'),
		'A-ADE': _('Practise adjectives in adessive'),
		'A-ABL': _('Practise adjectives in ablative'),
		'A-ALL': _('Practise adjectives in allative'),
		'A-TRA': _('Practise adjectives in translative'),
