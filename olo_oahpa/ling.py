...
class Paradigm:
	...
	def generate_all(self, dialects):		
		...
		dialect = 'main'  # HU: There are no dialects defined for olo. I have defined this just to make the program work.
