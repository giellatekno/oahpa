...
def index(request):
	...
	return render_to_response('olo_oahpa_main.html', c,
...
def leksa_game(request, place=False):
	...
	if sess_lang:
		...
		if sess_lang in ['olo', 'eng']: # maybe need to remove 'eng' from this list later on 
			sess_lang = 'eng' # was: nob
	else:
		sess_lang = 'eng' # was: nob

	default_langpair = 'olo%s' % sess_lang
