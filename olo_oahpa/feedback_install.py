...
from olo_drill.models import Feedbackmsg,Feedbacktext,Dialect,Comment,Tag
...
from olo_drill.models import Form
...
class Feedback_install(object):
	...
	def read_feedback(self, feedbackfile, wordfile, append):
		...
		if Feedbackmsg.objects.count() == 0:
			print >> sys.stderr, "No message strings have been installed (messages.olo.xml, etc)."
			sys.exit()
