# Django settings for olo_oahpa project.
# -*- encoding: utf-8 -*-
import os.path
import sys

os.environ['PYTHON_EGG_CACHE'] = '/tmp'
os.environ['DJANGO_SETTINGS_MODULE'] = 'olo_oahpa.settings'
...
path = '/Users/mslm/main/ped/olo_oahpa'
...
# DATABASE_NAME = here('olooahpa.db.sql')             # Or path to database file if using sqlite3.
...
# URL_PREFIX = 'smaoahpa'
URL_PREFIX = 'olo_oahpa'
# URL_PREFIX = '책arjel'

# Absolute path to the directory that holds media.
#MEDIA_ROOT = "/home/olo_oahpa/olo_oahpa/media/"
...
TEMPLATE_DIRS = (
	...
	os.path.join(os.path.dirname(__file__), 'olo_drill/templates').replace('\\','/'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = ( "django.contrib.auth.context_processors.auth",
				...
				"olo_oahpa.courses.context_processors.request_user",
				"olo_oahpa.conf.context_processors.dialect",
				"olo_oahpa.conf.context_processors.site_root",
				"olo_oahpa.conf.context_processors.grammarlinks",
)
...
INSTALLED_APPS = (
	...
	'olo_oahpa.olo_drill',
        'olo_oahpa.conf',
	# 'olo_oahpa.courses',
        #'olo_oahpa.olo_feedback',
        'olo_oahpa.management',
        'gunicorn',
)
...
if os.uname()[1] == 'gtlab.uit.no':
    FST_DIRECTORY = '/opt/smi/olo/bin'
    LOOKUP_TOOL = '/usr/local/bin/lookup'
else:
    FST_DIRECTORY = '/Users/mslm/main/langs/olo/src'
...
LOGIN_REDIRECT_URL = '/olo_oahpa/courses/'
LOGIN_URL = '/olo_oahpa/courses/login/'

CACHES = {
	'default': {
		'BACKEND': 'django.core.cache.backends.filebased.FileBasedCache',
		'LOCATION': '/var/tmp/olooahpa_cache'
	},
}
