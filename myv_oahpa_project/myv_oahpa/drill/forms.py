...
from models import *
#from game import *
#from myv_oahpa.myv_drill.game import relax
import datetime
import socket
import sys, os
import itertools
...
CASE_CHOICES = (
    ...
    ('N-PL-NOM-DEF', _('Definite nominative plural')),
    ('N-DAT-DEF', _('Definite dative singular')),
    ('N-PL-DAT-DEF', _('Definite dative plural')),
    ('N-ABL-DEF', _('Definite ablative singular')),
    ('N-PL-ABL-DEF', _('Definite ablative plural')),
    ('N-PL-ILL-DEF', _('Definite illative plural')),
    ('N-ELA-DEF', _('Definite elative singular')),
    ('N-PL-ELA-DEF', _('Definite elative plural')),
    ('N-INE-DEF', _('Definite inessive singular')),
    ('N-PL-INE-DEF', _('Definite inessive plural')),
...
TRANS_CHOICES = (
    ...
    ('myvnob', _('Erzya to Norwegian')),
    ('nobmyv', _('Norwegian to Erzya')),
...
from myv_oahpa.settings import INFINITIVE_SUBTRACT as infinitives_sub
from myv_oahpa.settings import INFINITIVE_ADD as infinitives_add
...
class OahpaSettings(forms.Form):
	...
	def set_default_data(self):
		self.default_data = {
					'language' : 'myv',  # sme in univ_oahpa
...
class NumSettings(OahpaSettings):
	...
	default_data = {'language' : 'myv', 'numlanguage' : 'myv', 'dialogue' : 'GG', 'maxnum' : '10', 'numgame': 'numeral'}
...
class KlokkaSettings(NumSettings):
	...
	default_data = {'language' : 'myv', 'numlanguage' : 'myv', 'dialogue' : 'GG', 'gametype' : 'kl1', 'numgame': 'string'}
...
class DatoSettings(KlokkaSettings):
	...
	default_data = {'language' : 'myv', 'numlanguage' : 'myv', 'numgame': 'string'}
...
def vasta_is_correct(self,question,qwords,language,utterance_name=None):
    ...
    #logfile = open('/home/myv_oahpa/myv_oahpa/myv_drill/vastaF_log.txt','w')
   ...
   # except socket.timeout:
    ...
    if not language in ["nob","sme","fin","eng","swe","myv"]: language="eng"
...
def cealkka_is_correct(self,question,qwords,awords,language,question_id=None):  #was: question_id=None
    ...
    #logfile = open('/home/myv_oahpa/myv_oahpa/myv_drill/vastas_log.txt', 'w')
    host = 'localhost'
    port = 9000  # was: 9000, TODO - add to settings.py
    size = 1024
    ...
    #if language == "fi" : language = "fin"
    #if language == "en" : language = "eng"
    if not language in ["nob","sme","fin","eng","swe","myv","rus"]: language="eng"
