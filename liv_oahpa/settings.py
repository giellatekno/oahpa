...
#	('Lene Antonsen', 'lene.antonsen@uit.no'),
 #       ('Pavel Iosad', 'pavel.iosad@uit.no'),
...
# DATABASE_NAME = here('livoahpa.db.sql')             # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = (
	...
	os.path.join(os.path.dirname(__file__), 'liv_drill/templates').replace('\\','/'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = ( "django.contrib.auth.context_processors.auth",
				...
				"liv_oahpa.courses.context_processors.request_user",
				"liv_oahpa.conf.context_processors.dialect",
				"liv_oahpa.conf.context_processors.site_root",
				"liv_oahpa.conf.context_processors.grammarlinks",
)
...
if os.uname()[1] == 'gtlab.uit.no':
    FST_DIRECTORY = '/opt/smi/liv/bin'
    LOOKUP_TOOL = '/usr/local/bin/lookup'
else:
    FST_DIRECTORY = '/Users/mslm/main/langs/liv/bin'
...
LOGIN_REDIRECT_URL = '/liv_oahpa/courses/'
LOGIN_URL = '/liv_oahpa/courses/login/'
