# Django settings for vep_oahpa project.
# -*- encoding: utf-8 -*-
import os.path
import sys

os.environ['PYTHON_EGG_CACHE'] = '/tmp'
os.environ['DJANGO_SETTINGS_MODULE'] = 'vep_oahpa.settings'
...
path = '/Users/mslm/main/ped/vep_oahpa'
...
# DATABASE_NAME = here('vepoahpa.db.sql')             # Or path to database file if using sqlite3.
...
# http://testing.oahpa.no/vep_oahpa/

# URL_PREFIX = 'smaoahpa'
URL_PREFIX = 'vep_oahpa'
# URL_PREFIX = '책arjel'

# Absolute path to the directory that holds media.
#MEDIA_ROOT = "/home/vep_oahpa/vep_oahpa/media/"
...
TEMPLATE_DIRS = (
	...
	os.path.join(os.path.dirname(__file__), 'vep_drill/templates').replace('\\','/'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = ( "django.contrib.auth.context_processors.auth",
				...
				"vep_oahpa.courses.context_processors.request_user",
				"vep_oahpa.conf.context_processors.dialect",
				"vep_oahpa.conf.context_processors.site_root",
				"vep_oahpa.conf.context_processors.grammarlinks",
)
...
INSTALLED_APPS = (
	...
	'vep_oahpa.vep_drill',
        'vep_oahpa.conf',
	# 'vep_oahpa.courses',
        #'vep_oahpa.vep_feedback',
        'vep_oahpa.management',
        'gunicorn',
)
...
if os.uname()[1] == 'gtlab.uit.no':
    FST_DIRECTORY = '/opt/smi/vep/bin'
    LOOKUP_TOOL = '/usr/local/bin/lookup'
else:
    FST_DIRECTORY = '/Users/mslm/main/langs/vep/src'
...
LOGIN_REDIRECT_URL = '/vep_oahpa/courses/'
LOGIN_URL = '/vep_oahpa/courses/login/'

CACHES = {
	'default': {
		'BACKEND': 'django.core.cache.backends.filebased.FileBasedCache',
		'LOCATION': '/var/tmp/vepoahpa_cache'
	},
}
