...
from vep_drill.models import Feedbackmsg,Feedbacktext,Dialect,Comment,Tag
...
from vep_drill.models import Form
...
class Feedback_install(object):
	...
	def read_feedback(self, feedbackfile, wordfile, append):
		...
		if Feedbackmsg.objects.count() == 0:
			print >> sys.stderr, "No message strings have been installed (messages.vep.xml, etc)."
			sys.exit()
