...
from vep_oahpa.vep_drill.models import *
from vep_oahpa.vep_drill.forms import *
...
try:
	L1 = vep_oahpa.settings.L1
except:
	L1 = 'vep'  # was: sme

try:
	LOOKUP_TOOL = vep_oahpa.settings.LOOKUP_TOOL
except:
	LOOKUP_TOOL = 'lookup'


try:
	FST_DIRECTORY = vep_oahpa.settings.FST_DIRECTORY
except:
	FST_DIRECTORY = False

try:
	DEFAULT_DIALECT = vep_oahpa.settings.DEFAULT_DIALECT
except:
