...
try:
	FST_DIRECTORY = fkv_oahpa.settings.FST_DIRECTORY
except:
	FST_DIRECTORY = False

try:
	DEFAULT_DIALECT = fkv_oahpa.settings.DEFAULT_DIALECT
except:
...
class NumGame(Game):
	generate_fst = 'fkv-num.fst'
	answers_fst = 'fkv-inum.fst'
...
class Klokka(NumGame):
	...
	generate_fst = 'iclock-fkv.fst'
	answers_fst = 'clock-fkv.fst'
...
class Dato(Klokka):
	...
	generate_fst = 'idate-fkv.fst'
	answers_fst = 'date-fkv.fst'
