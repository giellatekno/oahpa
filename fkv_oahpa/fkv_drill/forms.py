...
from models import *
#from game import *
#from fkv_oahpa.fkv_drill.game import relax
import datetime
import socket
import sys, os
import itertools
...
from fkv_oahpa.settings import INFINITIVE_SUBTRACT as infinitives_sub
from fkv_oahpa.settings import INFINITIVE_ADD as infinitives_add
...
class OahpaSettings(forms.Form):
	...
	def set_default_data(self):
		self.default_data = {
					'language' : 'fkv',  # sme in univ_oahpa
...
class DatoSettings(KlokkaSettings):
	...
	default_data = {'language' : 'fkv', 'numlanguage' : 'fkv', 'numgame': 'string'}
...
def vasta_is_correct(self,question,qwords,language,utterance_name=None):
    ...
    #logfile = open('/home/fkv_oahpa/fkv_oahpa/fkv_drill/vastaF_log.txt','w')
...
def cealkka_is_correct(self,question,qwords,awords,language,question_id=None):  #was: question_id=None
    ...
    #logfile = open('/home/fkv_oahpa/fkv_oahpa/fkv_drill/vastas_log.txt', 'w')
    host = 'localhost'
    port = 9000  # was: 9000, TODO - add to settings.py
    size = 1024
