...
from smn_drill.models import Tagname, Tagset, Form
...
class Command(BaseCommand):
    ...
    def test_agreement(self):
        fname = 'smn_drill/management/commands/testquestions_agreement_defs.yaml'
    ...
    def handle(self, *args, **options):
        ...
        agreement_defs = 'smn_drill/management/commands/testquestions_agreement_defs.yaml'
