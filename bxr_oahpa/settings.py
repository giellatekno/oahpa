...
path = '/Users/mslm/main/ped/bxr_oahpa'
...
# DATABASE_NAME = here('bxroahpa.db.sql')             # Or path to database file if using sqlite3.
...
# URL_PREFIX = 'smaoahpa'
URL_PREFIX = 'bxr_oahpa'
# URL_PREFIX = '책arjel'

# Absolute path to the directory that holds media.
#MEDIA_ROOT = "/home/bxr_oahpa/bxr_oahpa/media/"
...
TEMPLATE_DIRS = (
	...
	os.path.join(os.path.dirname(__file__), 'bxr_drill/templates').replace('\\','/'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = ( "django.contrib.auth.context_processors.auth",
				...
				"bxr_oahpa.courses.context_processors.request_user",
				"bxr_oahpa.conf.context_processors.dialect",
				"bxr_oahpa.conf.context_processors.site_root",
				"bxr_oahpa.conf.context_processors.grammarlinks",
)
...
INSTALLED_APPS = (
	...
	'bxr_oahpa.bxr_drill',
        'bxr_oahpa.conf',
	# 'bxr_oahpa.courses',
        #'bxr_oahpa.bxr_feedback',
        'bxr_oahpa.management',
        'gunicorn',
)
...
if os.uname()[1] == 'gtlab.uit.no':
    FST_DIRECTORY = '/opt/smi/bxr/bin'
    LOOKUP_TOOL = '/usr/local/bin/lookup'
else:
    FST_DIRECTORY = '/Users/mslm/main/langs/bxr/src'
...
LOGIN_REDIRECT_URL = '/bxr_oahpa/courses/'
LOGIN_URL = '/bxr_oahpa/courses/login/'

CACHES = {
	'default': {
		'BACKEND': 'django.core.cache.backends.filebased.FileBasedCache',
		'LOCATION': '/var/tmp/bxroahpa_cache'
	},
}
