...
from bxr_drill.models import Feedbackmsg,Feedbacktext,Dialect,Comment,Tag
...
from bxr_drill.models import Form
...
class Feedback_install(object):
	...
	def read_feedback(self, feedbackfile, wordfile, append):
		...
		if Feedbackmsg.objects.count() == 0:
			print >> sys.stderr, "No message strings have been installed (messages.bxr.xml, etc)."
			sys.exit()
