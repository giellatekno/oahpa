...
def index(request):
	...
	return render_to_response('bxr_oahpa_main.html', c,
...
def leksa_game(request, place=False):
	...
	if sess_lang:
		...
		if sess_lang in ['bxr', 'eng']: # maybe need to remove 'eng' from this list later on 
			sess_lang = 'est' # was: nob
	else:
		sess_lang = 'est' # was: nob

	default_langpair = 'bxr%s' % sess_lang
