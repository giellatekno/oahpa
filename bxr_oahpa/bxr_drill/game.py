...
from bxr_oahpa.bxr_drill.models import *
from bxr_oahpa.bxr_drill.forms import *
...
try:
	L1 = bxr_oahpa.settings.L1
except:
	L1 = 'bxr'  # was: sme

try:
	LOOKUP_TOOL = bxr_oahpa.settings.LOOKUP_TOOL
except:
	LOOKUP_TOOL = 'lookup'


try:
	FST_DIRECTORY = bxr_oahpa.settings.FST_DIRECTORY
except:
	FST_DIRECTORY = False

try:
	DEFAULT_DIALECT = bxr_oahpa.settings.DEFAULT_DIALECT
except:
