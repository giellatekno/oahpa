...
class Morfaview(Gameview):
	gamenames = {
		...
		'A-ACC': 'Practise adjectives in accusative',
		'A-COM': 'Practise adjectives in comitative',
		'A-ESS': 'Practise adjectives in essive',
		'A-GEN': 'Practise adjectives in genitive',
		'A-NOM-PL': 'Practise adjectives in plural',
		'N-LOC': 'Practise adjectives in locative',
		'A-COMP': 'Practise comparative',
		'A-SUPERL': 'Practise superlative',
		'V-DER': 'Practise verb derivation',
		...
		'PREDPOS':  'Practise predicative in positive',
		'PREDCOMP':  'Practise predicative in comparative',
		'PREDSUP':  'Practise predicative in superlative',
		'NUM-ATTR':  'Practise numeral attributes',
		'NOMPL':  'Practise plural',
		'NOM':  'Practise nominative',
		'N-NOM':  'Practise nominative',
		'N-ILL':  'Practise illative',
		'N-ACC':  'Practise accusative',
		'N-COM':  'Practise comitative',
		'N-ESS':  'Practise essive',
		'N-GEN':  'Practise genitive',
		'N-NOM-PL':  'Practise plural',
		'N-LOC':  'Practise locative',
		'N-MIX':  'Practise a mix',
		'V-MIX':  'Practise a mix',
		'A-MIX':  'Practise a mix',
		'P-MIX':  'Practise a mix',
		'NUM-ILL':  'Practise numerals in illative',
		'NUM-ACC':  'Practise numerals in accusative',
		'NUM-COM':  'Practise numerals in comitative',
		'NUM-ESS':  'Practise numerals in essive',
		'NUM-GEN':  'Practise numerals in genitive',
		'NUM-NOM-PL':  'Practise numerals in plural',
		'NUM-LOC':  'Practise numerals in locative',
		'COLL-NUM':  'Practise collective numerals',
		'ORD-NUM':  'Practise ordinal numbers',
		'ORD-N-ILL':  'Practise ordinal numerals in illative',
		'ORD-N-ACC':  'Practise ordinal numerals in accusative',
		'ORD-N-COM':  'Practise ordinal numerals in comitative',
		'ORD-N-ESS':  'Practise ordinal numerals in essive',
		'ORD-N-GEN':  'Practise ordinal numerals in genitive',
		'ORD-N-NOM-PL':  'Practise ordinal numerals in plural',
		'ORD-N-LOC':  'Practise ordinal numerals in locative',
		'COLL-N-ILL':  'Practise collective numerals in illative',
		'COLL-N-ACC':  'Practise collective numerals in accusative',
		'COLL-N-COM':  'Practise collective numerals in comitative',
		'COLL-N-ESS':  'Practise collective numerals in essive',
		'COLL-N-GEN':  'Practise collective numerals in genitive',
		'COLL-NOMPL':  'Practise collective numerals in plural',
		'COLL-N-LOC':  'Practise collective numerals in locative',
		'PRS':  'Practise present',
		'PRT':  'Practise past',
		'PRF':  'Practise perfect',
		'GER':  'Practise gerund',
		'COND':  'Practise conditional',
		'IMPRT':  'Practise imperative',
		'POT':  'Practise potential',
		'V-PRS':  'Practise present',
		'V-PRT':  'Practise past',
		'V-PRF':  'Practise perfect',
		'V-GER':  'Practise gerund',
		'V-COND':  'Practise conditional',
		'V-IMPRT':  'Practise imperative',
		'V-POT':  'Practise potential',
		'P-PERS':  'Practise ',
