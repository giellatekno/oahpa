...
<!--+
    ...
    | LEMMA __ POS __ type __ TRANSLATION_1,TRANSLATION_2,TRANSLATION_n __ SEMCLASS_1,SEMCLASS_2, SEMCLASS_n __ chapter
    | into oahpa lexicon files in  xml format split by pos values
    | Usage: java -Xmx2024m net.sf.saxon.Transform -it:main fromCSV2oahpa_full.xsl inFile=inputfile.csv src_lang=hdn tgt_lang=eng
    | 
    +-->
