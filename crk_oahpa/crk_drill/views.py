...
class Morfaview(Gameview):
	gamenames = {
		...
		'A-LOC': _('Practise adjectives in locative'),
		...
		'N-DIM':  _('Here are diminutive forms. Write the baseform.'),
		'N-PX':  _('Practise possessive forms.'),
		...
		'PRT':  _('Practise verbs in past tense.'),
		...
		'V-TA-FUT-DEF': _('Practice transitive animate future definite (TA)'),
		'V-TA-FUT-INT': _('Practice transitive animate future intentional (TA)'),

		'V-TI-PRS': _('Practice transitive inanimate present (TI)'),
		'V-TI-PRT': _('Practice transitive inanimate preterite (TI)'),
		'V-TI-FUT-DEF': _('Practice transitive inanimate future definite (TI)'),
		'V-TI-FUT-INT': _('Practice transitive inanimate future intentional (TI)'),

		'V-TA-CNJ-PRS': _('Practice transitive animate conjunct present (TA)'),
		'V-TA-CNJ-PRT': _('Practice transitive animate conjunct preterite (TA)'),
		'V-TA-CNJ-FUT-INT': _('Practice intransitive inanimate conjunct future intentional (TI)'),
		'V-AI-CNJ-PRS': _('Practice intransitive animate conjunct present tense (AI)'),
	    'V-AI-CNJ-PRT':  _('Practice intransitive animate conjunct past tense (AI)'),
	    'V-TI-CNJ-PRT':  _('Practice transitive inanimate conjunct past tense (TI)'),
	    'V-TI-CNJ-FUT-INT':  _('Practice intransitive inanimate conjunct future intentional (TI)'),
	    'V-AI-CNJ-FUT-INT':  _('Practice intransitive animate conjunct future intentional (AI)'),
