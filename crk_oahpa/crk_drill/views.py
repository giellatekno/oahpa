...
class Morfaview(Gameview):
	gamenames = {
		...
		'N-PX-GROUP1': _('Practise possessive nouns'),
		'N-PX-GROUP2': _('Practise possessive nouns'),
		'N-PX-GROUP3': _('Practise possessive nouns'),
		'PX-LOC': _('Practise possessive nouns in locative'),
		...
		'N-PL':  _('Practise plural nouns'),
		'N-LOC': _('Practise nouns in locative'),
		...
		'PRS':  _('Practise changing person and number in present tense.'),
		'PRT':  _('Practise changing person and number in past tense.'),
		...
		'V-FUTINT':  _('Practise future intentional'),
		'V-FUTDEF':  _('Practise future definite'),
		'V-PRT':  _('Practise past tense'),
