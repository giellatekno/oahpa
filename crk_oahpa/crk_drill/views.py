...
class Morfaview(Gameview):
	gamenames = {
		...
		'V-AI-PRS':  _('Practise present tense (AI)'),
		...
		'V-TA-CNJ-PRS': _('Practice conjunct present (TA)'),
		'V-TA-CNJ-PRT': _('Practice conjunct preterite (TA)'),
		'V-TA-CNJ-FUT-INT': _('Practice conjunct future intentional (TI)'),
