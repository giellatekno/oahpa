...
urlpatterns = patterns('django.views.generic.simple',
    (r'^oahpa/$', 'direct_to_template', {'template': '/home/oahpa/ped/oahpa/templates/redirect.html'}),
    (r'^oahpa/[\w\d_]+/$', 'direct_to_template', {'template': '/home/oahpa/ped/oahpa/templates/redirect.html'}),
#    (r'^oahpa/i18n/', include('django.conf.urls.i18n')),
 #   (r'^oahpa/media/(?P<path>.*)$', 'django.views.static.serve',
  #                      {'document_root': '/home/oahpa/ped/oahpa/media'}),
   ...
   # (r'^oahpa/vasta/$', 'oahpa.drill.views.vasta'),  
    ...
    #(r'^oahpa/courses/', include('oahpa.courses.urls')),
)
