...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('drill', ['Comment'])

        # Adding model 'Log'
        db.create_table('drill_log', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('drill', ['Log'])

        # Adding model 'Semtype'
        db.create_table('drill_semtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('semtype', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('drill', ['Semtype'])

        # Adding model 'Source'
        db.create_table('drill_source', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('drill', ['Source'])

        # Adding model 'Dialect'
        db.create_table('drill_dialect', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dialect', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('drill', ['Dialect'])

        # Adding model 'MorphPhonTag'
        db.create_table('drill_morphphontag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('drill', ['MorphPhonTag'])

        # Adding unique constraint on 'MorphPhonTag', fields ['stem', 'gender', 'animate', 'inflection_class', 'stress_class', 'reflexive']
        db.create_unique('drill_morphphontag', ['stem', 'gender', 'animate', 'inflection_class', 'stress_class', 'reflexive'])

        # Adding model 'Word'
        db.create_table('drill_word', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('morphophon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.MorphPhonTag'], null=True)),
        ))
        db.send_create_signal('drill', ['Word'])

        # Adding M2M table for field semtype on 'Word'
        db.create_table('drill_word_semtype', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('word', models.ForeignKey(orm['drill.word'], null=False)),
            ('semtype', models.ForeignKey(orm['drill.semtype'], null=False))
        ))
        db.create_unique('drill_word_semtype', ['word_id', 'semtype_id'])

        # Adding M2M table for field source on 'Word'
        db.create_table('drill_word_source', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('word', models.ForeignKey(orm['drill.word'], null=False)),
            ('source', models.ForeignKey(orm['drill.source'], null=False))
        ))
        db.create_unique('drill_word_source', ['word_id', 'source_id'])

        # Adding M2M table for field dialects on 'Word'
        db.create_table('drill_word_dialects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('word', models.ForeignKey(orm['drill.word'], null=False)),
            ('dialect', models.ForeignKey(orm['drill.dialect'], null=False))
        ))
        db.create_unique('drill_word_dialects', ['word_id', 'dialect_id'])

        # Adding model 'WordTranslation'
        db.create_table('drill_wordtranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('word', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Word'])),
        ...
        db.send_create_signal('drill', ['WordTranslation'])

        # Adding M2M table for field semtype on 'WordTranslation'
        db.create_table('drill_wordtranslation_semtype', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wordtranslation', models.ForeignKey(orm['drill.wordtranslation'], null=False)),
            ('semtype', models.ForeignKey(orm['drill.semtype'], null=False))
        ))
        db.create_unique('drill_wordtranslation_semtype', ['wordtranslation_id', 'semtype_id'])

        # Adding M2M table for field source on 'WordTranslation'
        db.create_table('drill_wordtranslation_source', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wordtranslation', models.ForeignKey(orm['drill.wordtranslation'], null=False)),
            ('source', models.ForeignKey(orm['drill.source'], null=False))
        ))
        db.create_unique('drill_wordtranslation_source', ['wordtranslation_id', 'source_id'])

        # Adding model 'Tagset'
        db.create_table('drill_tagset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tagset', self.gf('django.db.models.fields.CharField')(max_length=25)),
        ))
        db.send_create_signal('drill', ['Tagset'])

        # Adding model 'Tagname'
        db.create_table('drill_tagname', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tagname', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('tagset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Tagset'])),
        ))
        db.send_create_signal('drill', ['Tagname'])

        # Adding model 'Tag'
        db.create_table('drill_tag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('drill', ['Tag'])

        # Adding model 'Form'
        db.create_table('drill_form', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('word', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Word'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Tag'])),
            ('fullform', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('drill', ['Form'])

        # Adding M2M table for field dialects on 'Form'
        db.create_table('drill_form_dialects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('form', models.ForeignKey(orm['drill.form'], null=False)),
            ('dialect', models.ForeignKey(orm['drill.dialect'], null=False))
        ))
        db.create_unique('drill_form_dialects', ['form_id', 'dialect_id'])

        # Adding M2M table for field feedback on 'Form'
        db.create_table('drill_form_feedback', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('form', models.ForeignKey(orm['drill.form'], null=False)),
            ('feedbackmsg', models.ForeignKey(orm['drill.feedbackmsg'], null=False))
        ))
        db.create_unique('drill_form_feedback', ['form_id', 'feedbackmsg_id'])

        # Adding model 'Feedbackmsg'
        db.create_table('drill_feedbackmsg', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('msgid', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('drill', ['Feedbackmsg'])

        # Adding model 'Feedbacktext'
        db.create_table('drill_feedbacktext', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('feedbackmsg', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Feedbackmsg'])),
            ('order', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
        ))
        db.send_create_signal('drill', ['Feedbacktext'])
        ...
        db.create_table('drill_question', (
            ...
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='answer_set', null=True, to=orm['drill.Question'])),
        ...
        db.send_create_signal('drill', ['Question'])

        # Adding M2M table for field source on 'Question'
        db.create_table('drill_question_source', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm['drill.question'], null=False)),
            ('source', models.ForeignKey(orm['drill.source'], null=False))
        ))
        db.create_unique('drill_question_source', ['question_id', 'source_id'])

        # Adding model 'QElement'
        db.create_table('drill_qelement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Question'], null=True)),
            ...
            ('task', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('gametype', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('agreement', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agreement_set', null=True, to=orm['drill.QElement'])),
            ('semtype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Semtype'], null=True)),
            ('game', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('copy', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='copy_set', null=True, to=orm['drill.QElement'])),
        ))
        db.send_create_signal('drill', ['QElement'])

        # Adding M2M table for field tags on 'QElement'
        db.create_table('drill_qelement_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('qelement', models.ForeignKey(orm['drill.qelement'], null=False)),
            ('tag', models.ForeignKey(orm['drill.tag'], null=False))
        ))
        db.create_unique('drill_qelement_tags', ['qelement_id', 'tag_id'])

        # Adding model 'WordQElement'
        db.create_table('drill_wordqelement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('word', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Word'], null=True)),
            ('qelement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.QElement'], null=True)),
        ))
        db.send_create_signal('drill', ['WordQElement'])

        # Adding model 'Dialogue'
        db.create_table('drill_dialogue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('drill', ['Dialogue'])

        # Adding model 'Utterance'
        db.create_table('drill_utterance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Topic'])),
        ))
        db.send_create_signal('drill', ['Utterance'])

        # Adding M2M table for field links on 'Utterance'
        db.create_table('drill_utterance_links', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('utterance', models.ForeignKey(orm['drill.utterance'], null=False)),
            ('linkutterance', models.ForeignKey(orm['drill.linkutterance'], null=False))
        ))
        db.create_unique('drill_utterance_links', ['utterance_id', 'linkutterance_id'])

        # Adding M2M table for field formlist on 'Utterance'
        db.create_table('drill_utterance_formlist', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('utterance', models.ForeignKey(orm['drill.utterance'], null=False)),
            ('form', models.ForeignKey(orm['drill.form'], null=False))
        ))
        db.create_unique('drill_utterance_formlist', ['utterance_id', 'form_id'])

        # Adding model 'UElement'
        db.create_table('drill_uelement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('utterance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Utterance'], null=True)),
            ('syntax', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Tag'], null=True, blank=True)),
        ))
        db.send_create_signal('drill', ['UElement'])

        # Adding model 'LinkUtterance'
        db.create_table('drill_linkutterance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Utterance'], null=True, blank=True)),
        ...
        db.send_create_signal('drill', ['LinkUtterance'])

        # Adding model 'Topic'
        db.create_table('drill_topic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('topicname', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('dialogue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drill.Dialogue'])),
        ...
        db.send_create_signal('drill', ['Topic'])

        # Adding M2M table for field formlist on 'Topic'
        db.create_table('drill_topic_formlist', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('topic', models.ForeignKey(orm['drill.topic'], null=False)),
            ('form', models.ForeignKey(orm['drill.form'], null=False))
        ))
        db.create_unique('drill_topic_formlist', ['topic_id', 'form_id'])

        # Adding model 'Grammarlinks'
        db.create_table('drill_grammarlinks', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal('drill', ['Grammarlinks'])


    def backwards(self, orm):
        # Removing unique constraint on 'MorphPhonTag', fields ['stem', 'gender', 'animate', 'inflection_class', 'stress_class', 'reflexive']
        db.delete_unique('drill_morphphontag', ['stem', 'gender', 'animate', 'inflection_class', 'stress_class', 'reflexive'])

        # Deleting model 'Comment'
        db.delete_table('drill_comment')

        # Deleting model 'Log'
        db.delete_table('drill_log')

        # Deleting model 'Semtype'
        db.delete_table('drill_semtype')

        # Deleting model 'Source'
        db.delete_table('drill_source')

        # Deleting model 'Dialect'
        db.delete_table('drill_dialect')

        # Deleting model 'MorphPhonTag'
        db.delete_table('drill_morphphontag')

        # Deleting model 'Word'
        db.delete_table('drill_word')

        # Removing M2M table for field semtype on 'Word'
        db.delete_table('drill_word_semtype')

        # Removing M2M table for field source on 'Word'
        db.delete_table('drill_word_source')

        # Removing M2M table for field dialects on 'Word'
        db.delete_table('drill_word_dialects')

        # Deleting model 'WordTranslation'
        db.delete_table('drill_wordtranslation')

        # Removing M2M table for field semtype on 'WordTranslation'
        db.delete_table('drill_wordtranslation_semtype')

        # Removing M2M table for field source on 'WordTranslation'
        db.delete_table('drill_wordtranslation_source')

        # Deleting model 'Tagset'
        db.delete_table('drill_tagset')

        # Deleting model 'Tagname'
        db.delete_table('drill_tagname')

        # Deleting model 'Tag'
        db.delete_table('drill_tag')

        # Deleting model 'Form'
        db.delete_table('drill_form')

        # Removing M2M table for field dialects on 'Form'
        db.delete_table('drill_form_dialects')

        # Removing M2M table for field feedback on 'Form'
        db.delete_table('drill_form_feedback')

        # Deleting model 'Feedbackmsg'
        db.delete_table('drill_feedbackmsg')

        # Deleting model 'Feedbacktext'
        db.delete_table('drill_feedbacktext')

        # Deleting model 'Question'
        db.delete_table('drill_question')

        # Removing M2M table for field source on 'Question'
        db.delete_table('drill_question_source')

        # Deleting model 'QElement'
        db.delete_table('drill_qelement')

        # Removing M2M table for field tags on 'QElement'
        db.delete_table('drill_qelement_tags')

        # Deleting model 'WordQElement'
        db.delete_table('drill_wordqelement')

        # Deleting model 'Dialogue'
        db.delete_table('drill_dialogue')

        # Deleting model 'Utterance'
        db.delete_table('drill_utterance')

        # Removing M2M table for field links on 'Utterance'
        db.delete_table('drill_utterance_links')

        # Removing M2M table for field formlist on 'Utterance'
        db.delete_table('drill_utterance_formlist')

        # Deleting model 'UElement'
        db.delete_table('drill_uelement')

        # Deleting model 'LinkUtterance'
        db.delete_table('drill_linkutterance')

        # Deleting model 'Topic'
        db.delete_table('drill_topic')

        # Removing M2M table for field formlist on 'Topic'
        db.delete_table('drill_topic_formlist')

        # Deleting model 'Grammarlinks'
        db.delete_table('drill_grammarlinks')
