...
def index(request):
	...
	return render_to_response('myv_oahpa_main.html', c,
...
class Morfaview(Gameview):
	gamenames = {
		...
		'N-PX': _('Practice noun possessive suffixes in singular'),
        'N-PX-PL': _('Practice noun possessive suffixes in plural'),
		...
		'N-NOM-PL':  _('Practise plural nominative indefinite'),
		'N-GEN-DEF':  _('Practice singular genitive definite'),
		'N-PL-GEN-DEF':  _('Practice plural genitive definite'),
        'N-NOM-DEF': _('Practice singular nominative definite'),
        'N-PL-NOM-DEF': _('Practice plural nominative definite'),
        'N-DAT-DEF': _('Practice singular dative definite'),
        'N-PL-DAT-DEF': _('Practice plural dative definite'),
        'N-ABL-DEF': _('Practice singular ablative definite'),
        'N-PL-ABL-DEF': _('Practice plural ablative definite'),
        'N-PL-ILL-DEF': _('Practice plural illative definite'),
        'N-ELA-DEF': _('Practice singular elative definite'),
        'N-PL-ELA-DEF': _('Practice plural elative definite'),
        'N-INE-DEF': _('Practice singular inessive definite'),
        'N-PL-INE-DEF': _('Practice plural inessive definite'),
        'N-PRL-DEF': _('Practice singular prolative definite'),
        'N-PL-PRL-DEF': _('Practice plural prolative definite'),
        'N-CMPR-DEF': _('Practice singular comparative definite'),
        'N-PL-CMPR-DEF': _('Practice plural comparative definite'),
        'N-TRA-DEF': _('Practice singular translative definite'),
        'N-PL-TRA-DEF': _('Practice plural translative definite'),
        'N-ABE-DEF': _('Practice singular abessive definite'),
        'N-PL-ABE-DEF': _('Practice plural abessive definite'),
		'NOM':  _('Practise nominative'),
		'N-NOM':  _('Practise nominative'),
		'N-ILL':  _('Practise illative indefinite'),
		'N-GEN':  _('Practise genitive indefinite'),
		'N-NOM-PL':  _('Practise nominative plural indefinite'),
		'N-INE':  _('Practise inessive indefinite'),
		'N-DAT':  _('Practise dative indefinite'),
		'N-ELA':  _('Practise elative indefinite'),
		'N-ABL':  _('Practise ablative indefinite'),
		'N-ABL-DEF': _('Practice ablative definite'),
		'N-ABE':  _('Practise abessive indefinite'),
		'N-CMPR':  _('Practise comparative indefinite'),
		'N-PRL':  _('Practise prolative indefinite'),
		'N-TRA':  _('Practise translative indefinite'),
		'N-LAT':  _('Practise lative indefinite'),
		'N-COM':  _('Practise comitative indefinite'),
		...
		'PRT1':  _('Practise first preterit'),
		'PRT2':  _('Practise second preterit'),
		...
		'V-PRT1':  _('Practise first preterit'),
		'V-PRT2':  _('Practise second preterit'),
