...
try:
        LOG_FILE = myv_oahpa.settings.LOG_FILE
except:
        LOG_FILE = False
...
class LeksaSettings(OahpaSettings):
	...
	default_data = {'gametype' : 'bare', 'language' : 'myv', 'dialogue' : 'GG', 
			'syll' : [], 
			'bisyllabic': False,
			'trisyllabic': False,
			'bisyllabic': False,
...
class NumSettings(OahpaSettings):
	...
	#numlanguage = forms.ChoiceField(initial='myv', choices=NUMLANGUAGE_CHOICES, widget=forms.RadioSelect)
