...
cat $GTHOME/ped/sme/univ_oahpa_data/data_sme/sme/a_smenob.xml | tr "\n" " " | tr "<" "\n" | grep '^l ' | cut -d ">" -f2 | sort -u > t3
...
echo "||  lemma  ||  Attr  ||  Sg Nom || Comp Attr || Comp Sg Nom || Superl Sg Nom" >> nudoc/gen/sme_adjOahpatabellGG.jspwiki
