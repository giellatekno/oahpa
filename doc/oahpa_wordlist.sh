...
cat ../sme/src/n_smenob.xml | sed 's/<tg/$<tg/' | sed 's/<l/$<l/' | tr "\n" "€" | tr "$" "\n" | egrep '(<l |"fin")' | tr "€" "\n" | egrep '(<l |<t)' | grep -v '<tg' | tr -s " " | tr "<" ">" | cut -d ">" -f3 > oassi2
cat ../sme/src/n_smenob.xml | sed 's/<tg/$<tg/' | sed 's/<l/$<l/' | tr "\n" "€" | tr "$" "\n" | egrep '(<l |"fin")' | tr "€" "\n" | egrep '(<l |<t)' | grep -v '<tg' | tr -s " " | tr "<" ">" | cut -d ">" -f1,2 > oassi1
cat oassi1 | sed 's/>t pos=".*" stat="pref"/fasihtta:       /' | sed 's/>l /€lemma:/' | sed 's/>t/:   /' | cut -d ":" -f1 > oassinew1
paste -d "_" oassinew1 oassi2 | tr "€" "\n" |  sed 's/_/ - /' | sed 's/^ //' >> nudoc/gen/smefin_nounlist.txt
rm oassi* 

echo "Dato: $DATO" > nudoc/gen/smefin_adjlist.txt
cat ../sme/src/a_smenob.xml | sed 's/<tg/$<tg/' | sed 's/<l/$<l/' | tr "\n" "€" | tr "$" "\n" | egrep '(<l |"fin")' | tr "€" "\n" | egrep '(<l |<t)' | grep -v '<tg' | tr -s " " | tr "<" ">" | cut -d ">" -f3 > oassi2
cat ../sme/src/a_smenob.xml | sed 's/<tg/$<tg/' | sed 's/<l/$<l/' | tr "\n" "€" | tr "$" "\n" | egrep '(<l |"fin")' | tr "€" "\n" | egrep '(<l |<t)' | grep -v '<tg' | tr -s " " | tr "<" ">" | cut -d ">" -f1,2 > oassi1
cat oassi1 | sed 's/>t pos=".*" stat="pref"/fasihtta:       /' | sed 's/>l /€lemma:/' | sed 's/>t/:   /' | cut -d ":" -f1 > oassinew1
paste -d "_" oassinew1 oassi2 | tr "€" "\n" |  sed 's/_/ - /' | sed 's/^ //' >> nudoc/gen/smefin_adjlist.txt
rm oassi* 

echo "Dato: $DATO" > nudoc/gen/smefin_advlist.txt
cat ../sme/src/adv_smenob.xml | sed 's/<tg/$<tg/' | sed 's/<l/$<l/' | tr "\n" "€" | tr "$" "\n" | egrep '(<l |"fin")' | tr "€" "\n" | egrep '(<l |<t)' | grep -v '<tg' | tr -s " " | tr "<" ">" | cut -d ">" -f3 > oassi2
cat ../sme/src/adv_smenob.xml | sed 's/<tg/$<tg/' | sed 's/<l/$<l/' | tr "\n" "€" | tr "$" "\n" | egrep '(<l |"fin")' | tr "€" "\n" | egrep '(<l |<t)' | grep -v '<tg' | tr -s " " | tr "<" ">" | cut -d ">" -f1,2 > oassi1
cat oassi1 | sed 's/>t pos=".*" stat="pref"/fasihtta:       /' | sed 's/>l /€lemma:/' | sed 's/>t/:   /' | cut -d ":" -f1 > oassinew1
paste -d "_" oassinew1 oassi2 | tr "€" "\n" |  sed 's/_/ - /' | sed 's/^ //' >> nudoc/gen/smefin_advlist.txt
rm oassi* 

echo "Dato: $DATO" > nudoc/gen/smefin_vlist.txt
cat ../sme/src/v_smenob.xml | sed 's/<tg/$<tg/' | sed 's/<l/$<l/' | tr "\n" "€" | tr "$" "\n" | egrep '(<l |"fin")' | tr "€" "\n" | egrep '(<l |<t)' | grep -v '<tg' | tr -s " " | tr "<" ">" | cut -d ">" -f3 > oassi2
cat ../sme/src/v_smenob.xml | sed 's/<tg/$<tg/' | sed 's/<l/$<l/' | tr "\n" "€" | tr "$" "\n" | egrep '(<l |"fin")' | tr "€" "\n" | egrep '(<l |<t)' | grep -v '<tg' | tr -s " " | tr "<" ">" | cut -d ">" -f1,2 > oassi1
cat oassi1 | sed 's/>t pos=".*" stat="pref"/fasihtta:       /' | sed 's/>l /€lemma:/' | sed 's/>t/:   /' | cut -d ":" -f1 > oassinew1
paste -d "_" oassinew1 oassi2 | tr "€" "\n" |  sed 's/_/ - /' | sed 's/^ //' >> nudoc/gen/smefin_vlist.txt
rm oassi* 

echo "Dato: $DATO" > nudoc/gen/smefin_mwelist.txt
cat ../sme/src/multiword_smenob.xml | sed 's/<tg/$<tg/' | sed 's/<l/$<l/' | tr "\n" "€" | tr "$" "\n" | egrep '(<l |"fin")' | tr "€" "\n" | egrep '(<l |<t)' | grep -v '<tg' | tr -s " " | tr "<" ">" | cut -d ">" -f3 > oassi2
cat ../sme/src/multiword_smenob.xml | sed 's/<tg/$<tg/' | sed 's/<l/$<l/' | tr "\n" "€" | tr "$" "\n" | egrep '(<l |"fin")' | tr "€" "\n" | egrep '(<l |<t)' | grep -v '<tg' | tr -s " " | tr "<" ">" | cut -d ">" -f1,2 > oassi1
cat oassi1 | sed 's/>t pos=".*" stat="pref"/fasihtta:       /' | sed 's/>l /€lemma:/' | sed 's/>t/:   /' | cut -d ":" -f1 > oassinew1
paste -d "_" oassinew1 oassi2 | tr "€" "\n" |  sed 's/_/ - /' | sed 's/^ //' >> nudoc/gen/smefin_mwelist.txt
rm oassi* 
