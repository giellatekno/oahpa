...
echo "!!!Tabell over adjektiv" > adjtabell.jspwiki
echo "" >> adjtabell.jspwiki
echo " ||  lemma  ||  Attr  ||  Pred  ||  Comp  ||  Superl " >> adjtabell.jspwiki

echo "!!!Reversert tabell over adjektiv" > adjtabellrev.jspwiki
echo "" >> adjtabellrev.jspwiki
echo " ||  lemma  ||  Attr  ||  Pred  ||  Comp  ||  Superl " >> adjtabellrev.jspwiki
...
cat tadjforms >> adjtabell.jspwiki

#rm tattr tpred tcomp tsuperl

cat t1 | perl -nle 'print scalar reverse $_' > t1rev

paste t1rev tadjforms | sort | cut -f2 | grep '[A-Za-z]' >> adjtabellrev.jspwiki
