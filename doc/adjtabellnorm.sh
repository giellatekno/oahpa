...
cat t1|sed 's/$/+A+Attr/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tattr1
cat t2|sed 's/$/+A+Attr/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tattr2
cat t3|sed 's/$/+A+Attr/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tattr3

cat t1|sed 's/$/+A+Sg+Nom/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tsgnom1
cat t2|sed 's/$/+A+Sg+Nom/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tsgnom2
cat t3|sed 's/$/+A+Sg+Nom/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tsgnom3

cat t1|sed 's/$/+A+Comp+Sg+Nom/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tcomp1
cat t2|sed 's/$/+A+Comp+Sg+Nom/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tcomp2
cat t3|sed 's/$/+A+Comp+Sg+Nom/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tcomp3

cat t1|sed 's/$/+A+Superl+Sg+Nom/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tsuperl1
cat t2|sed 's/$/+A+Superl+Sg+Nom/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tsuperl2
cat t3|sed 's/$/+A+Superl+Sg+Nom/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A.*/-/'|tr '\t' ',' > tsuperl3

cat t1|sed 's/$/+A+Sg+Acc/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A+.*/-/'|tr '\t' ',' > tAcc1
cat t2|sed 's/$/+A+Sg+Acc/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A+.*/-/'|tr '\t' ',' > tAcc2
cat t3|sed 's/$/+A+Sg+Acc/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A+.*/-/'|tr '\t' ',' > tAcc3

cat t1|sed 's/$/+A+Sg+Ill/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A+.*/-/'|tr '\t' ',' > tIll1
cat t2|sed 's/$/+A+Sg+Ill/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A+.*/-/'|tr '\t' ',' > tIll2
cat t3|sed 's/$/+A+Sg+Ill/;'| lookup -q $GTHOME/langs/sma/src/generator.gt.xfst |tr '\n' '™'|sed 's/™™/£/g;'|tr '£' '\n'|tr '™' '\t'|cut -f2,4,6,8,10,12,14,16|sed 's/.*+A+.*/-/'|tr '\t' ',' > tIll3
