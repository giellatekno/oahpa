...
cp final_data.txt  testdata/corrVF_data.txt
grep -v ";" testdata/corrVF_data.txt | grep "&" | grep -v dia >> vastaftestrapport.txt
...
cp final_data.txt testdata/errVF_data.txt
