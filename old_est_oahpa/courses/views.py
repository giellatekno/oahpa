...
def cookie_login(request, next_page=None, required=False, **kwargs):
	...
	if not next_page:
		next_page = '/est_oahpa/courses/' # TODO: change next url for deep links
	...
	if cookie_uid:
		...
		return HttpResponseRedirect('/est_oahpa/courses/standard_login/') # TODO: check
...
def cookie_logout(request, next_page=None, **kwargs):
	...
	if not next_page:
		next_page = '/est_oahpa/courses/logout/'
