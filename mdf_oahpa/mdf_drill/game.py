...
from mdf_oahpa.mdf_drill.models import *
from mdf_oahpa.mdf_drill.forms import *
...
try:
	L1 = mdf_oahpa.settings.L1
except:
	L1 = 'mdf'  # was: sme

try:
	LOOKUP_TOOL = mdf_oahpa.settings.LOOKUP_TOOL
except:
	LOOKUP_TOOL = 'lookup'


try:
	FST_DIRECTORY = mdf_oahpa.settings.FST_DIRECTORY
except:
	FST_DIRECTORY = False

try:
	DEFAULT_DIALECT = mdf_oahpa.settings.DEFAULT_DIALECT
except:
