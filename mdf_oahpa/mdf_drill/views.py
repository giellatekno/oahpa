...
def index(request):
	...
	return render_to_response('mdf_oahpa_main.html', c,
...
class Morfaview(Gameview):
	gamenames = {
		...
		'N-NOM-PL-DEF':  _('Practise definite nominative plural'),
		'N-NOM-DEF':  _('Practise definite nominative'),
		'N-GEN-DEF':  _('Practise definite genitive'),		
		'N-PL-GEN-DEF':  _('Practise definite genitive plural'),
        ...
        'N-LAT': _('Practise lative'),
        'N-ABE':  _('Practise abessive'),
        'N-ABESS': _('Practise abessive'),
		'N-CMPR':  _('Practise comparative'),
		'N-NOM-PL':  _('Practise indefinite nominative plural'),
