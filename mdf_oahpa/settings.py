# Django settings for mdf_oahpa project.
# -*- encoding: utf-8 -*-
import os.path
import sys
...
path = '/Users/mslm/main/ped/mdf_oahpa'
...
# DATABASE_NAME = here('mdfoahpa.db.sql')             # Or path to database file if using sqlite3.
...
# URL_PREFIX = 'smaoahpa'
URL_PREFIX = 'mdf_oahpa'
# URL_PREFIX = '책arjel'

# Absolute path to the directory that holds media.
#MEDIA_ROOT = "/home/mdf_oahpa/mdf_oahpa/media/"
...
TEMPLATE_DIRS = (
	...
	os.path.join(os.path.dirname(__file__), 'mdf_drill/templates').replace('\\','/'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = ( "django.contrib.auth.context_processors.auth",
				...
				"mdf_oahpa.courses.context_processors.request_user",
				"mdf_oahpa.conf.context_processors.dialect",
				"mdf_oahpa.conf.context_processors.site_root",
				"mdf_oahpa.conf.context_processors.grammarlinks",
)
...
INSTALLED_APPS = (
	...
	'mdf_oahpa.mdf_drill',
        'mdf_oahpa.conf',
	# 'mdf_oahpa.courses',
        #'mdf_oahpa.mdf_feedback',
        'mdf_oahpa.management',
        'gunicorn',
)
...
if os.uname()[1] == 'gtlab.uit.no':
    FST_DIRECTORY = '/opt/smi/mdf/bin'
    LOOKUP_TOOL = '/usr/local/bin/lookup'
else:
    FST_DIRECTORY = '/Users/mslm/main/langs/mdf/src'
...
LOGIN_REDIRECT_URL = '/mdf_oahpa/courses/'
LOGIN_URL = '/mdf_oahpa/courses/login/'

CACHES = {
	'default': {
		'BACKEND': 'django.core.cache.backends.filebased.FileBasedCache',
		'LOCATION': '/var/tmp/mdfoahpa_cache'
	},
}
